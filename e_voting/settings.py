...
STATIC_ROOT = os.path.join(BASE_DIR, 'static') #For Development Session
...
EMAIL_USE_SSL = False  # Set to True if using SSL/TLS
EMAIL_HOST_USER = 'abdurerg01@gmail.com' # Your Gmail email address
EMAIL_HOST_PASSWORD = 'dmxu sbde lrxj jqrf'  # Your Gmail password
