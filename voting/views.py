...
def dashboard(request):
    ...
    if user.voter.otp is None or not user.voter.verified:
        ...
        if voter.otp_sent >= 3:
            ...
            try:
                ...
                send_mail(
                    ...
                    f'Your OTP is: {otp}',
                    'abdurerg01@gmail.com',
                    [email],
                    fail_silently=False,
                )
                # Update how many OTPs have been sent to this voter
                ...
                response = f"OTP could not be sent. Error: {str(e)}"
